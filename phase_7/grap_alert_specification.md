...
**Date:** 2026-09-16  
**Depends On:** `phase_7/target_definition.md`, `phase_7/risk_classification_specification.md`
...
**Next Document:** `phase_7/evaluation_strategy.md` — Unified evaluation framework combining classification metrics, binary severe-event detection, episode detection, lead-time analysis, and cross-horizon synthesis.