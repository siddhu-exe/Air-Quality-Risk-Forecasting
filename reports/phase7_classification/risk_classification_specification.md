...
**Date:** 2026-09-16  
**Depends On:** `reports/phase7_classification/target_definition.md`
...
**Next Document:** `reports/phase7_classification/grap_alert_specification.md` — GRAP Stage I–IV alerting logic, forecast-based invocation, lead-time evaluation, and episode detection.